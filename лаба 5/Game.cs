...
namespace лаба_5
{
    class Game
    {
        // Константа, определяющая размер поля (10x10)
        private const int SIZE = 10;
        // Константы, определяющие обозначения элементов полей
        private const string EMPTY_CELL = " ";
        private const string PLAYER_X = "X";
        private const string PLAYER_O = "O";

        // Метод для игры в угадай число
        

        // Метод для игры в Крестики-нолики
